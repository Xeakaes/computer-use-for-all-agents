"""Linux backend — fail-closed stub.

ROADMAP Phase 5 will implement real X11 support (mss + pyautogui + xdotool).
...
class LinuxBackend(PlatformBackend):
    """Fail-closed stub; see ROADMAP Phase 5 for the implementation plan."""
