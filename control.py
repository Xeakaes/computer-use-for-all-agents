...
# Keys that must NEVER be sent through the API (prevents accidental
# window/system loss).
# NOTE: Only Alt+F4 is banned — Alt+Tab and other Alt combos are legitimate
# Windows interactions.  Win key and bare Delete (Shift+Delete risk of
# permanent deletion) remain blocked.
...
def _assert_allowed(keys: list[str]) -> None:
    """Raise PermissionError if the requested key combo is forbidden."""
